...
--> statement-breakpoint
DROP TABLE "cleanup-hub_account";--> statement-breakpoint
DROP TABLE "cleanup-hub_post";--> statement-breakpoint
DROP TABLE "cleanup-hub_session";--> statement-breakpoint
DROP TABLE "cleanup-hub_user";--> statement-breakpoint
DROP TABLE "cleanup-hub_verification_token";--> statement-breakpoint
DO $$ BEGIN
